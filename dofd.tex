...
\begin{equation}
  \label{eq:61}
  u_n=\frac{uf^2}{f^2+Nc_n(u-f)}
  % #61
\end{equation}
and
\begin{equation}
  \label{eq:62}
  u_f=\frac{uf^2}{f^2-Nc_f(u-f)}\quad.
  % #61
\end{equation}
...
\begin{equation}
  \label{eq:un}
  u_n = \frac{c_f}{c_n+c_f}\left(\frac{f^2}{Nc_f}+f\right)
  % #64
\end{equation}
...
\begin{eqnarray}
     u_n & = & \frac{uf^2-Ncf\left(\frac1p-1\right)(u-f)}{f^2 + Nc(u-f)}\label{eq:89}\\
     u_f & = & \frac{uf^2-Ncf\left(\frac1p-1\right)(u-f)}{f^2 - Nc(u-f)}\label{eq:90}
\end{eqnarray}
...
\begin{equation}
  \label{eq:3un}
  u_n = \frac{\frac{f^2}{Nc} + f - f\left(\frac1p-1\right)}2\quad,
  % #92
\end{equation}
...
\begin{equation}
  \label{eq:98}
  u-u_n=\frac{\left[Ncf\left(\frac 1p-1\right) + Ncu\right](u-f)}{f^2
    + Nc(u-f)}
  % #98
\end{equation}
%% Page 24 
