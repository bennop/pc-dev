...
\label{eq:b}
\end{equation}
<<viewangle, echo = FALSE, fig.cap = 'Viewing angle vs.\ focal length'>>=
...
As Fig.~\ref{fig:viewangle} is a log-log-plot, it can be seen that the angle is inversely proportional to the focal length $f$ for longer $f$
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Focus}
\label{sec:focus}
