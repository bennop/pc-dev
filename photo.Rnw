...
big a CoC is acceptable depends onthe desired resolution, not
...
sensors, and appropriately scaled 18.6\,$\mu$m for an APC-sized
sensor.
...
The hyperfocal distance (HFD) is the distance that when set on a lens results in the largest possible depth of field for a given focal length/aperture combination: everything between a minumum distance of $\mathrm{HFD}/2$ to $\infty$ is \emph{in focus}.
...
\Fref{fig:HFDfull}, for (Canon) APC sensors from
\Fref{fig:HFDapc}. Both plots use the exact value from \Eref{eq:HFDexact}.
...
\end{eqnarray}
\cleardoublepage
\section{DOF full format}
\subsection{24mm}\label{sec:24}
<<portrait24, echo=FALSE, fig.height=9, fig.cap = paste0(24,'mm'), warning=FALSE,results='hide'>>=
full.dof.plot(24, 1.4, xlim=c(1,3), ylim = c(0.01,10), log="xy",  y.e=15)
@

\subsection{35mm}\label{sec:35}
<<portrait35, echo=FALSE, fig.height=9, fig.cap = paste0(35,'mm'), warning=FALSE,results='hide'>>=
full.dof.plot(35, 1.4, xlim=c(1,3), ylim = c(0.01,10), log="xy",  y.e=15)
@

\subsection{50mm}\label{sec:50}
<<portrait50, echo=FALSE, fig.height=9, fig.cap = paste0(50,'mm'), warning=FALSE,results='hide'>>=
full.dof.plot(50, 1.2, xlim=c(1,3), ylim = c(0.01,10), log="xy",  y.e=15)
@

\subsection{70mm}\label{sec:70}
<<portrait70, echo=FALSE, fig.height=9, fig.cap = paste0(70,'mm'), warning=FALSE,results='hide'>>=
full.dof.plot(70, 1.2, xlim=c(1,3), ylim = c(0.01,10), log="xy",  y.e=15)
@

\subsection{85mm}\label{sec:85}
<<portrait85, echo=FALSE, fig.height=9, fig.cap = paste0(85,'mm'), warning=FALSE,results='hide'>>=
full.dof.plot(85, 1.2, xlim=c(1,3), ylim = c(0.01,10), log="xy",  y.e=15)
@

\subsection{90mm}\label{sec:90}
<<portrait90, echo=FALSE, fig.height=9, fig.cap = paste0(90,'mm'), warning=FALSE,results='hide'>>=
full.dof.plot(90, 1.2, xlim=c(1,3), ylim = c(0.01,10), log="xy",  y.e=15)
@

\subsection{100mm}\label{sec:100}
<<portrait100, echo=FALSE, fig.height=9, fig.cap = paste0(100,'mm'), warning=FALSE,results='hide'>>=
full.dof.plot(100, 1.2, xlim=c(1,3), ylim = c(0.01,10), log="xy",  y.e=15)
@

\subsection{135mm}\label{sec:135}
<<portrait135, echo=FALSE, fig.height=9, fig.cap = paste0(135,'mm'), warning=FALSE,results='hide'>>=
